...
export class Jig extends APIResource {
   ...
   */
  retrieve(id: string, options?: RequestOptions): APIPromise<JigRetrieveResponse> {
   ...
   */
  update(id: string, body: JigUpdateParams, options?: RequestOptions): APIPromise<JigUpdateResponse> {
...
export interface JigRetrieveResponse {
  /**
   ...
   */
  environment_variables?: Array<JigRetrieveResponse.EnvironmentVariable>;
   ...
   */
  replica_events?: { [key: string]: JigRetrieveResponse.ReplicaEvents };
   ...
   */
  volumes?: Array<JigRetrieveResponse.Volume>;
}

export namespace JigRetrieveResponse {
...
export interface JigUpdateResponse {
  /**
   * ID is the unique identifier of the deployment
   */
  id?: string;
   ...
   * EnvironmentVariables is a list of environment variables set in the container
   */
  environment_variables?: Array<JigUpdateResponse.EnvironmentVariable>;
   ...
   * ReplicaEvents is a mapping of replica names or IDs to their status events
   */
  replica_events?: { [key: string]: JigUpdateResponse.ReplicaEvents };
   ...
   * Volumes is a list of volume mounts for this deployment
   */
  volumes?: Array<JigUpdateResponse.Volume>;
}

export namespace JigUpdateResponse {
  export interface EnvironmentVariable {
    /**
     * Name is the environment variable name (e.g., "DATABASE_URL"). Must start with a
     * letter or underscore, followed by letters, numbers, or underscores
...
export interface JigDeployResponse {
   ...
   * EnvironmentVariables is a list of environment variables set in the container
   */
  environment_variables?: Array<JigDeployResponse.EnvironmentVariable>;
   ...
   * ReplicaEvents is a mapping of replica names or IDs to their status events
   */
  replica_events?: { [key: string]: JigDeployResponse.ReplicaEvents };
   ...
   * Volumes is a list of volume mounts for this deployment
   */
  volumes?: Array<JigDeployResponse.Volume>;
}

export namespace JigDeployResponse {
  export interface EnvironmentVariable {
    /**
     * Name is the environment variable name (e.g., "DATABASE_URL"). Must start with a
     * letter or underscore, followed by letters, numbers, or underscores
