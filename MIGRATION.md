...
- `client.beta.endpoints.rollouts.previewDefaults()`
...
- `client.beta.rl.operations.retrieveCustomForwardBackward()`
- `client.beta.rl.operations.retrieveForward()`
- `client.beta.rl.operations.retrieveForwardBackward()`
- `client.beta.rl.operations.retrieveInferenceCheckpoint()`
- `client.beta.rl.operations.retrieveOptimStep()`
- `client.beta.rl.operations.retrieveSample()`
- `client.beta.rl.operations.retrieveTrainingCheckpoint()`
- `client.beta.rl.operations.retrieveWeightsSync()`
