...
- <code><a href="./src/resources/beta/rl/sessions.ts">Session</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">SessionError</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">SessionErrorCode</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">SessionMetadata</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">SessionStatus</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">SessionsListResponse</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">TrainingCheckpoint</a></code>
- <code><a href="./src/resources/beta/rl/sessions.ts">WandbMetadata</a></code>

Methods:

- <code title="post /rl/training-sessions">client.beta.rl.sessions.<a href="./src/resources/beta/rl/sessions.ts">create</a>({ ...params }) -> Session</code>
- <code title="get /rl/training-sessions/{session_id}">client.beta.rl.sessions.<a href="./src/resources/beta/rl/sessions.ts">retrieve</a>(sessionID) -> Session</code>
- <code title="get /rl/training-sessions">client.beta.rl.sessions.<a href="./src/resources/beta/rl/sessions.ts">list</a>({ ...params }) -> SessionsListResponse</code>
- <code title="post /rl/training-sessions/{session_id}/stop">client.beta.rl.sessions.<a href="./src/resources/beta/rl/sessions.ts">stop</a>(sessionID) -> Session</code>

### Operations

Types:

- <code><a href="./src/resources/beta/rl/operations.ts">AdamParams</a></code>
...
- <code><a href="./src/resources/beta/rl/operations.ts">EncodedTextChunk</a></code>
...
- <code><a href="./src/resources/beta/rl/operations.ts">LossFnOutput</a></code>
...
- <code><a href="./src/resources/beta/rl/operations.ts">ModelInputChunk</a></code>
- <code><a href="./src/resources/beta/rl/operations.ts">MuonParams</a></code>
- <code><a href="./src/resources/beta/rl/operations.ts">OperationError</a></code>
- <code><a href="./src/resources/beta/rl/operations.ts">OperationErrorCode</a></code>
- <code><a href="./src/resources/beta/rl/operations.ts">OperationStatus</a></code>
...
- <code><a href="./src/resources/beta/rl/operations.ts">PromptTopLogprobs</a></code>
- <code><a href="./src/resources/beta/rl/operations.ts">RoutedExperts</a></code>
...
- <code><a href="./src/resources/beta/rl/operations.ts">TensorData</a></code>
...
- <code><a href="./src/resources/beta/rl/operations.ts">WeightsSyncOperation</a></code>
- <code><a href="./src/resources/beta/rl/operations.ts">WeightsSyncResult</a></code>
...
- <code title="get /rl/training-sessions/{session_id}/operations/weights-sync/{operation_id}">client.beta.rl.operations.<a href="./src/resources/beta/rl/operations.ts">retrieveWeightsSync</a>(operationID, { ...params }) -> WeightsSyncOperation</code>
...
- <code title="post /rl/training-sessions/{session_id}/operations/weights-sync">client.beta.rl.operations.<a href="./src/resources/beta/rl/operations.ts">weightsSync</a>(sessionID, { ...params }) -> WeightsSyncOperation</code>

### Checkpoints

Types:

- <code><a href="./src/resources/beta/rl/checkpoints.ts">Checkpoint</a></code>
...
- <code><a href="./src/resources/beta/rl/checkpoints.ts">CheckpointType</a></code>
- <code><a href="./src/resources/beta/rl/checkpoints.ts">CheckpointVariant</a></code>
- <code><a href="./src/resources/beta/rl/checkpoints.ts">CheckpointsListResponse</a></code>

Methods:

- <code title="get /rl/checkpoints/{id}">client.beta.rl.checkpoints.<a href="./src/resources/beta/rl/checkpoints.ts">retrieve</a>(id) -> Checkpoint</code>
- <code title="get /rl/checkpoints">client.beta.rl.checkpoints.<a href="./src/resources/beta/rl/checkpoints.ts">list</a>({ ...params }) -> CheckpointsListResponse</code>
...
- <code><a href="./src/resources/fine-tuning.ts">FineTuneTokenizedDatasetRetrieveResponse</a></code>
...
- <code title="get /fine-tunes/{id}/download-tokenized-dataset">client.fineTuning.<a href="./src/resources/fine-tuning.ts">retrieveTokenizedDataset</a>(id) -> FineTuneTokenizedDatasetRetrieveResponse</code>
